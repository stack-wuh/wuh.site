...
const Gallery: React.FC<galleryPropsType> = (props) => {
  ...
  return <div className="ww_gallery">
    <Slider ref={slideRef} {...slideConfig}>
      {
        (galleryData.galleryList).map(item => (<div key={item.url} className={innerClassnames}>
    ...
    <div className="ww_gallery__footer">
      ...
      <div className="ww_gallery__btns">
        <Button className='ww_gallery__btns--item' size='small' onClick={handlePrevSlide} icon='icon-arrow-lift' />
        <Button className='ww_gallery__btns--item' size='small' onClick={handleNextSlide} icon='icon-arrow-right' />
        <Button className='ww_gallery__btns--item' size='small' onClick={handleClose} icon='icon-searchclose' />
      </div>
    </div>
  </div>
}
