...
const Modal: React.FC<ModalPropsTypes> = (props) => {
  ...
  const footer = props.footer ? (<> <Button onClick={handleCancel} type='primary'>取消</Button> </>) : null

  const outer = (<CSSTransition in={visible} timeout={500} classNames='alert' unmountOnExit>
    <div className='ww_modal'>
      <div className={classnames('ww_modal__outer', wrapperClassName)}>
        <div className={classnames('ww_modal__header', { 'ww_modal__header--fixed': allowFixedHeader })}>
