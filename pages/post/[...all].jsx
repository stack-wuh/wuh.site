...
const Post = ({
  ...
  const { body, title, sub_title, cover_img, _id, keywords } = post
  ...
  return (<div className='post-info' ref={postRef}>
      ...
      <Alert 
        title="版权声明: 署名-非商业性使用-禁止演绎 3.0 中国大陆(CC BY-NC-ND 3.0 CN)"
...
export async function getServerSideProps (context) {
  ...
  const res = await fetch(API_ARTICLE_LIST+ encodeURIComponent(title))
  const row = res.data
